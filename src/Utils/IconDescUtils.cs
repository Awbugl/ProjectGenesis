...
namespace ProjectGenesis.Utils
{
    ...
    {
        internal static readonly Dictionary<int, Color> FluidColor = new Dictionary<int, Color>
                                                                     {
        ...
        private static readonly Dictionary<int, Color> OreColor = new Dictionary<int, Color>
                                                                  {
                                                       ...
                                                       CompentColor = new Dictionary<int, Color>
                                                                      {
                                                       ...
                                                       FullWithIconColor = new Dictionary<int, Color>
                                                                           {
                                                       ...
                                                       WhiteColor = new Dictionary<int, Color>
                                                                    {
                                                                        { 7610, new Color32(255, 255, 255, 255) }, // 核子单元
                                                                        { 7611, new Color32(255, 255, 255, 255) }, // 反物质单元
                                                                    },
                                                       MetalWithoutIconColor = new Dictionary<int, Color>
                                                                               {
                                                       ...
                                                       GlassColor = new Dictionary<int, Color>
                                                                    {
                                                                        { 7706, new Color32(91, 91, 91, 255) }, // 钨玻璃
                                                                    },
                                                       RodColor = new Dictionary<int, Color>
                                                                  {
        ...
        internal static IconToolNew.IconDesc GetIconDesc(int itemid)
        {
            ...
            if (FluidColor.TryGetValue(itemid, out Color value))
            {
            ...
            if (WhiteColor.TryGetValue(itemid, out value))
            {
                desc.faceColor = value;
                desc.sideColor = value;
            }
