...
namespace ProjectGenesis.Patches
{
    internal static partial class ModifyPlanetTheme
    {
        ...
        private static void GasGiantModify(ThemeProto theme)
        {
            ...
            {
                theme.GasItems = new[] { ProtoID.I氢, ProtoID.I甲烷, ProtoID.I氨, };
                theme.GasSpeeds = new float[] { theme.GasSpeeds[1], theme.GasSpeeds[1] * 0.7f, theme.GasSpeeds[1] * 0.6f, };
            }
            else if (theme.GasItems[0] == ProtoID.I氢 && theme.GasItems[1] == ProtoID.I重氢)
            {
                if (theme.GasSpeeds[1] < 0.1f)
                {
                    ...
                    var heliumGasSpeed =
                        (float)Maths.Clamp(0.2f - theme.GasSpeeds[1], theme.GasSpeeds[1] + 0.02f, theme.GasSpeeds[0] - 0.01f);
                ...
                else
                {
                    ...
                    theme.GasItems = new[] { ProtoID.I氢, ProtoID.I氦, ProtoID.I重氢, };
                    var heliumGasSpeed =
                        (float)Maths.Clamp(0.3f - theme.GasSpeeds[1], theme.GasSpeeds[1] + 0.02f, theme.GasSpeeds[0] - 0.01f);
                    theme.GasSpeeds = new float[] { theme.GasSpeeds[0] - heliumGasSpeed, heliumGasSpeed, theme.GasSpeeds[1], };
                }
            }
        }
